    ...
    <main className="grid min-h-[100dvh] place-items-center bg-zinc-950 px-4 py-10 text-white">
      <div className="w-full max-w-3xl">
        ...
        <div className="mx-auto mt-10 flex size-16 items-center justify-center rounded-full bg-emerald-500/15">
          {paidSignup ? (
            <Smartphone className="size-8 text-emerald-300" />
          ) : (
        ...
        {paidSignup ? (
          <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-5 space-y-4 text-sm">
            <div>
            ...
            <p className="text-xs leading-5 text-zinc-400">
              Copie a chave acima e cole no app do seu banco como Pix copia e
              cola. Depois envie o comprovante no WhatsApp pra liberar o login.
            </p>

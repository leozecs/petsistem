  ...
  public: {
    Tables: {
      ...
      pet_clinical_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "pet_clinical_entries_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: false
            referencedRelation: "appointments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pet_clinical_entries_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pet_clinical_entries_pet_id_fkey"
            columns: ["pet_id"]
            isOneToOne: false
            referencedRelation: "pets"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pet_clinical_entries_petshop_id_fkey"
            columns: ["petshop_id"]
            isOneToOne: false
            referencedRelation: "petshops"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pet_clinical_entries_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pet_clinical_entries_veterinarian_id_fkey"
            columns: ["veterinarian_id"]
            isOneToOne: false
            referencedRelation: "veterinarians"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      reconcile_billing_status: { Args: never; Returns: Json }
    }
    Enums: {
      appointment_status:
        | "pending"
